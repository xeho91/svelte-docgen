...
describe("POST /", () => {
	it("returns 200 on a valid request", async ({ expect }) => {
		...
		expect(data).toMatchInlineSnapshot(
			`{"props":[["custom",{"tags":[],"isBindable":false,"isExtended":false,"isOptional":false,"type":{"kind":"string"}}],["children",{"tags":[],"isBindable":false,"isExtended":false,"isOptional":true,"type":{"kind":"union","types":[{"kind":"undefined"},{"kind":"function","calls":[{"parameters":[{"name":"args","isOptional":false,"type":{"kind":"tuple","isReadonly":false,"elements":[]}}],"returns":{"kind":"intersection","types":[{"kind":"interface","members":[["{@render ...} must be called with a Snippet",{"isOptional":false,"isReadonly":false,"type":{"kind":"literal","subkind":"string","value":"import type { Snippet } from 'svelte'"}}]]},{"kind":"literal","subkind":"symbol"}]}}],"alias":"Snippet","sources":["<process-cwd>/node_modules/.pnpm/svelte@<semver>/node_modules/svelte/types/index.d.ts"]}],"nonNullable":{"kind":"function","calls":[{"parameters":[{"name":"args","isOptional":false,"type":{"kind":"tuple","isReadonly":false,"elements":[]}}],"returns":{"kind":"intersection","types":[{"kind":"interface","members":[["{@render ...} must be called with a Snippet",{"isOptional":false,"isReadonly":false,"type":{"kind":"literal","subkind":"string","value":"import type { Snippet } from 'svelte'"}}]]},{"kind":"literal","subkind":"symbol"}]}}],"alias":"Snippet","sources":["<process-cwd>/node_modules/.pnpm/svelte@5.10.0/node_modules/svelte/types/index.d.ts"]}}}]]}`,
		);
	});
